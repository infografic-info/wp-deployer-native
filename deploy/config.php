...
$mgmt_port       = 22;
$mgmt_user       = env('MGMT_USER') ?: getenv('MGMT_USER') ?: 'root';
...
// Configurações do pacote de deploy
set('deploy_package_name', env('DEPLOY_PACKAGE_NAME') ?: getenv('DEPLOY_PACKAGE_NAME') ?: 'infografic/wp-deployer-core');
set('deploy_package_version', env('DEPLOY_PACKAGE_VERSION') ?: getenv('DEPLOY_PACKAGE_VERSION') ?: '0.2.0');
set('deploy_templates_version', env('DEPLOY_TEMPLATES_VERSION') ?: getenv('DEPLOY_TEMPLATES_VERSION') ?: '0.2.0');
...
set('shared_files', ['wp-config.php', 'nginx.conf', 'robots.txt']);
...
set('wp_extra_salt_keys', ['ITSEC_ENCRYPTION_KEY']);

// Configurações de exclusão do pacote de deploy
// set('deploy_tar_excludes', [
//     '*/inc/admin/modules/import/dummy-data',
// ]);
